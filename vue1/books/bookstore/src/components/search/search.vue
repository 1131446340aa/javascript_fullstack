  ...
  <div>
    ...
    <BSroll>
      <div class="main" v-show="!value">
        ...
        <div class="hot-wrapper" v-for="(item,index) in hots" :key="index" @click="tobookdetail(item.book_ids)">
          <div class="left">
      ...
      <div class="search-wrapprt" v-show="value">
        <div class="search-item" v-for="item in books" :key="item.index" @click="tobookdetail(item.book_ids)" v-show="books.length">
          <div class="icon">
...
import { hot_search, search_book } from "../../network/index";
export default {
  components: {
    BSroll
  },
