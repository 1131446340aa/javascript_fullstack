<template>
  <div class="contaner">
    <div class="bg"></div>
    <div class="address">
      <span class="change-city" @click="isShow=!isShow">切换城市</span>
    ...
    <div class="select-city-box" v-show="isShow">
      <van-area
        :area-list="areaList"
        :columns-num="2"
        title="选择城市"
...
export default {
  ...
  methods: {
    ...
    confirm(selectCity) {
      this.isShow = false;
      console.log(selectCity[1]);
      this.cityData.city=selectCity[1].name
      this.seriesData=[]
     this.getCurrentCityData(this.cityData.city)
